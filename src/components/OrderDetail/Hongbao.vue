<template>
  <div class="scroll-container scroll">
    ...
    <div v-for="(v, i) in list" :key="i">
      <cell border-indent="true"  @click.native="showContent[i] = !showContent[i], $forceUpdate()"style='padding:0;border-bottom:1px solid #eee'>
    ...
    <x-dialog v-model="dialogVisible" hide-on-blur >
    	      <div class ='dialog' >
            <div class='dialog-title f18'>红包收益说明</div>
      <p>1、商户收益为您从每一笔红包订单分得的收益分成。</p>
